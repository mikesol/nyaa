...
instance Attr IonInput_ D.Autocapitalize E.Autocapitalize where
  attr D.Autocapitalize value = unsafeAttribute
    { key: "autocapitalize", value: prop' (E.unAutocapitalize value) }

instance Attr IonInput_ D.Autocomplete E.Autocomplete where
  attr D.Autocomplete value = unsafeAttribute
    { key: "autocomplete", value: prop' (E.unAutocomplete value) }

instance Attr IonInput_ I.Autocorrect E.Autocorrect where
  attr I.Autocorrect value = unsafeAttribute
    { key: "autocorrect", value: prop' (E.unAutocorrect value) }

instance Attr IonInput_ D.Autofocus Boolean where
  attr D.Autofocus value = unsafeAttribute
    { key: "autofocus", value: prop' (if value then "true" else "false") }

instance Attr IonInput_ I.ClearInput Boolean where
  attr I.ClearInput value = unsafeAttribute
    { key: "clear-input", value: prop' (if value then "true" else "false") }

instance Attr IonInput_ I.ClearOnEdit Boolean where
  attr I.ClearOnEdit value = unsafeAttribute
    { key: "clear-on-edit", value: prop' (if value then "true" else "false") }
...
instance Attr IonInput_ I.Debounce Number where
  attr I.Debounce value = unsafeAttribute
    { key: "debounce", value: prop' (show value) }
...
instance Attr IonInput_ I.Enterkeyhint E.Enterkeyhint where
  attr I.Enterkeyhint value = unsafeAttribute
    { key: "enterkeyhint", value: prop' (E.unEnterkeyhint value) }

instance Attr IonInput_ D.Inputmode E.Inputmode where
  attr D.Inputmode value = unsafeAttribute
    { key: "inputmode", value: prop' (E.unInputmode value) }
...
instance Attr IonInput_ D.Maxlength Number where
  attr D.Maxlength value = unsafeAttribute
    { key: "maxlength", value: prop' (show value) }
...
instance Attr IonInput_ D.Minlength Number where
  attr D.Minlength value = unsafeAttribute
    { key: "minlength", value: prop' (show value) }
...
instance Attr IonInput_ I.Multiple Boolean where
  attr I.Multiple value = unsafeAttribute
    { key: "multiple", value: prop' (if value then "true" else "false") }
...
instance Attr IonInput_ D.Placeholder String where
  attr D.Placeholder value = unsafeAttribute
    { key: "placeholder", value: prop' value }

instance Attr IonInput_ D.Readonly Boolean where
  attr D.Readonly value = unsafeAttribute
    { key: "readonly", value: prop' (if value then "true" else "false") }

instance Attr IonInput_ D.Required Boolean where
  attr D.Required value = unsafeAttribute
    { key: "required", value: prop' (if value then "true" else "false") }
...
instance Attr IonInput_ D.Spellcheck Boolean where
  attr D.Spellcheck value = unsafeAttribute
    { key: "spellcheck", value: prop' (if value then "true" else "false") }
...
instance Attr IonInput_ D.Xtype E.InputType where
  attr D.Xtype value = unsafeAttribute
    { key: "type", value: prop' (E.unInputType value) }
