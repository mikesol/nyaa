...
instance Attr IonItem_ I.Button Boolean where
  attr I.Button value = unsafeAttribute { key: "button", value: prop' (if value then "true" else "false") }
...
instance Attr IonItem_ I.Counter Boolean where
  attr I.Counter value = unsafeAttribute { key: "counter", value: prop' (if value then "true" else "false") }

instance Attr IonItem_ I.Detail Boolean where
  attr I.Detail value = unsafeAttribute { key: "detail", value: prop' (if value then "true" else "false") }

instance Attr IonItem_ I.DetailIcon String where
  attr I.DetailIcon value = unsafeAttribute { key: "detail-icon", value: prop' value }
...
instance Attr IonItem_ I.Fill E.Fill where
  attr I.Fill value = unsafeAttribute { key: "fill", value: prop' (E.unFill value) }
...
instance Attr IonItem_ I.Lines E.Lines where
  attr I.Lines value = unsafeAttribute { key: "lines", value: prop' (E.unLines value) }
...
instance Attr IonItem_ I.Shape E.ItemShape where
  attr I.Shape value = unsafeAttribute { key: "shape", value: prop' (E.unItemShape value) }
