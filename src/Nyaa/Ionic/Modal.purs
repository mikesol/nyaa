...
instance Attr IonModal_ D.Animated Boolean where
  attr D.Animated value = unsafeAttribute { key: "animated", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.BackdropBreakpoint Number where
  attr I.BackdropBreakpoint value = unsafeAttribute { key: "backdrop-breakpoint", value: prop' (show value) }

instance Attr IonModal_ I.BackdropDismiss Boolean where
  attr I.BackdropDismiss value = unsafeAttribute { key: "backdrop-dismiss", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.CanDismiss Boolean where
  attr I.CanDismiss value = unsafeAttribute { key: "can-dismiss", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.Handle Boolean where
  attr I.Handle value = unsafeAttribute { key: "handle", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.HandleBehavior E.HandleBehavior where
  attr I.HandleBehavior value = unsafeAttribute { key: "handle-behavior", value: prop' (E.unHandleBehavior value) }

instance Attr IonModal_ I.InitialBreakpoint Number where
  attr I.InitialBreakpoint value = unsafeAttribute { key: "initial-breakpoint", value: prop' (show value) }

instance Attr IonModal_ I.IsOpen Boolean where
  attr I.IsOpen value = unsafeAttribute { key: "is-open", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.KeepContentsMounted Boolean where
  attr I.KeepContentsMounted value = unsafeAttribute { key: "keep-contents-mounted", value: prop' (if value then "true" else "false") }

instance Attr IonModal_ I.KeyboardClose Boolean where
  attr I.KeyboardClose value = unsafeAttribute { key: "keyboard-close", value: prop' (if value then "true" else "false") }
...
instance Attr IonModal_ I.ShowBackdrop Boolean where
  attr I.ShowBackdrop value = unsafeAttribute { key: "show-backdrop", value: prop' (if value then "true" else "false") }
...
instance Attr IonModal_ I.OnIonBreakpointDidChange Cb where
  attr I.OnIonBreakpointDidChange value = unsafeAttribute { key: "ionBreakpointDidChange", value: cb' value }
...
instance Attr IonModal_ I.OnIonModalDidDismiss Cb where
  attr I.OnIonModalDidDismiss value = unsafeAttribute { key: "ionModalDidDismiss", value: cb' value }
...
instance Attr IonModal_ I.OnIonModalDidPresent Cb where
  attr I.OnIonModalDidPresent value = unsafeAttribute { key: "ionModalDidPresent", value: cb' value }
...
instance Attr IonModal_ I.OnIonModalWillDismiss Cb where
  attr I.OnIonModalWillDismiss value = unsafeAttribute { key: "ionModalWillDismiss", value: cb' value }
...
instance Attr IonModal_ I.OnIonModalWillPresent Cb where
  attr I.OnIonModalWillPresent value = unsafeAttribute { key: "ionModalWillPresent", value: cb' value }
...
foreign import dismiss :: IonModal -> Foreign -> String -> Effect (Promise Boolean)
foreign import getCurrentBreakpoint :: IonModal -> Effect (Promise (Nullable Number))
...
foreign import setCurrentBreakpoint :: IonModal -> Number -> Effect (Promise Unit)
